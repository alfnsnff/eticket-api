...
type TripayClient interface {
	CreatePayment(payload *TransactionRequest) (*Transaction, error)
	GetPaymentChannels() ([]*PaymentChannel, error)
	GetTransactionDetail(reference string) (*Transaction, error)
}
