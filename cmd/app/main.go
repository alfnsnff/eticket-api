...
func main() {
	...
	if err := db.AutoMigrate(&entities.Route{}, &entities.Class{}, &entities.Schedule{}, &entities.Ship{}, &entities.Harbor{}, &entities.Booking{}, &entities.Ticket{}, &entities.Manifest{}, &entities.Fare{}); err != nil {
